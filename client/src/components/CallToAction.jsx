    ...
    <div className=' bg-[#141414]  border-y border-[#262626] px-4 py-10 md:px-20 md:py-15'>
      <div className='flex flex-col md:flex-row gap-[30px] md:gap-[150px] py-[50px] md:py-[60px] md:px-20'>
        <div className='flex flex-col gap-[6px] md:gap-[10px]'>
          <h3 className='text-[28px] md:text-[38px] lg:text-[48px] leading-[1.5] font-semibold absolute-white'>
            Start Your Real Estate Journey Today
          </h3>
          <p className='text-sm md:text-base lg:text-[18px] leading-[1.5] font-medium text-[#999999]'>
        ...
        <button
          type='button'
          className='leading-[1.5] text-[14px] lg:text-[18px] md:shrink-0 md:self-center absolute-white text-center px-5 py-[14px] md:px-5 lg:px-6 md:py-[14px] lg:py-[18px] bg-[#703BF7] rounded-[8px]'
        >
          Explore Properties
        </button>
      </div>
