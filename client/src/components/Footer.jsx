...
const Footer = () => {
  return (
    <div className='w-full'>
      <div className='flex flex-col md:flex-row bg-[#141414] gap-[50px] px-4 py-[50px] md:gap-[80px] md:px-[162px] md:py-[100px]'>
        <div className='flex flex-col gap-[30px]'>
          ...
          <div className='flex justify-between gap-[6px] md:gap-[10px] px-5 md:px-6 py-[14px] md:py-[18px] border border-[#262626] rounded-xl'>
            <img
      ...
      <div className='px-4 py-5 md:px-[162px] md:py-3 gap-5 md:gap-0 flex flex-col-reverse md:flex-row justify-between items-center bg-[#1a1a1a]'>
