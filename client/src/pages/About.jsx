    ...
    <div className='bg-[#141414]'>
      ...
      <div className='px-4 py-10 md:px-20 md:py-20 lg:px-[165px] flex flex-col gap-10'>
        <div className='flex flex-col items-center justify-between md:flex-row gap-10'>
          <div className='md:basis-2/5 flex flex-col gap-2'>
            ...
            />
            <div className='flex flex-col md:gap-[10px] lg:gap-[14px]'>
              <h3 className='font-semibold text-[28px] md:text-[38px] lg:text-[48px] leading-[1.5] absolute-white'>
                Our Values
              </h3>
          ...
          <div className='md:basis-3/5 p-6 md:p-10 flex flex-col md:gap-6 border border-[#262626] rounded-[12px] shadow-effect'>
            <div className='md:flex md:gap-6 items-center md:border-b pb-3 border-[#262626] '>
              <div className='flex flex-col md:basis-1/2 gap-5 md:pr-5 md:border-r border-b border-[#262626] md:border-b-0'>
                <ValuesCard
                  title={"Trust"}
                  concise={
              ...
              <div className='flex flex-col md:basis-1/2 gap-5 md:pb-0 border-b border-[#262626] md:border-b-0'>
                <ValuesCard
                  title={"Excellence"}
                  concise={
            ...
            <div className='md:flex md:gap-6 items-center'>
              ...
              <div className='flex flex-col md:basis-1/2 gap-5'>
                <ValuesCard
      ...
      <div className='px-4 py-10 md:px-20 md:py-20 lg:px-[165px] flex flex-col gap-10'>
        ...
        <div className='flex flex-col gap-10'>
          <div className='flex flex-col gap-2 md:gap-[10px] lg:gap-[14px]'>
            ...
            <p className='font-medium text-sm md:text-base md:text-[18px] leading-[1.5] text-[#999999]'>
              Our story is one of continuous growth and evolution. We started as
              a small team with big dreams, determined to create a real estate
              platform that transcended the ordinary.
            </p>
          </div>
          <div className='flex flex-col md:flex-row gap-5 md:gap-[30px] lg:gap-10'>
            <AchievementCard
      ...
      <div className='px-4 py-10 md:px-20 md:py-20 lg:px-[165px] flex flex-col gap-10'>
        ...
        <div className='flex flex-col gap-10'>
          ...
          <div className='flex flex-col md:gap-10 lg:gap-[50px]'>
      ...
      <div className='px-4 py-10 md:px-20 md:py-20 lg:px-[165px] flex flex-col gap-10'>
        ...
        <div className='flex flex-col gap-10 md:gap-[60px]'>
          ...
          <div className='flex flex-col md:flex-row gap-[30px] '>
            <div className='flex flex-col gap-[30px] md:gap-10 lg:gap-[50px] p-6 md:p-10 border border-[#262626] rounded-[12px] shadow-effect'>
              <div className='flex flex-col md:flex-row md:justify-between md:items-center gap-5'>
                <div className=''>
                  <p className='font-medium text-[#999999] text-sm md:text-base lg:text-[18px] leading-[1.5]'>
                    Since 2019
                  </p>
                ...
                <button className='bg-[#1a1a1a] absolute-white leading-[1.5] font-medium text-sm lg:text-[18px] px-5 py-[14px] border border-[#262626] rounded-lg'>
                  Visit Website
                </button>
              </div>
              <div className='flex gap-4'>
                <div className='md:basis-1/2 flex flex-col gap-[2px] md:gap-[6px] lg:gap-2'>
                  <p className='text-[#999999] text-[12px] md:text-sm lg:text-[18px] font-medium leading-[1.5] flex gap-[2px]  item-center'>
                    <img
                  ...
                  <p className='absolute-white leading-[1.5] font-medium text-sm md:text-base lg:text-[18px]'>
                    Commercial Real Estate
                  </p>
                </div>
                <div className='pl-4 border-l border-[#262626] md:basis-1/2 flex flex-col gap-[2px] md:gap-[6px] lg:gap-2'>
                  <p className='text-[#999999] text-[12px] md:text-sm font-medium lg:text-[18px] leading-[1.5] flex gap-[2px] item-center'>
                    <img
              ...
              <div className='flex flex-col border border-[#262626] gap-2 md:gap-[10px] p-5 md:p-6 rounded-[12px]'>
                <p className='text-[#999999] leading-[1.5] font-medium text-[14px] md:text-base lg:text-[18px]'>
                  What They Said 🤗
                </p>
                <p className='absolute-white leading-[1.5] font-medium text-sm md:text-base lg:text-[18px]'>
            ...
            <div className='flex flex-col gap-[30px] md:gap-10 lg:gap-[50px] p-6 md:p-10 border border-[#262626] rounded-[12px] shadow-effect'>
              ...
              <div className='flex flex-col border border-[#262626] gap-2 md:gap-[10px] p-5 md:p-6 rounded-[12px]'>
                ...
                <p className='absolute-white leading-[1.5] font-medium text-sm md:text-base lg:text-[18px]'>
                  JOIAgent's ability to identify prime retail locations helped
