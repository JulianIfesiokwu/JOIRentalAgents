  ...
  return (
    <div className='bg-[#141414]'>
      ...
      <div className='flex flex-col gap-10'>
        <div className='flex flex-col gap-[10px] px-4 py-[50px] border-b border-[#262626]'>
        ...
        <div className='flex flex-col gap-5 px-4'>
          <form className='flex items-center justify-between gap-[6px] px-4 py-[14px] border border-[#262626] rounded-xl shadow-effect'>
            <input
            ...
            />
            <button
              className='px-5 py-[14px] rounded-[8px] bg-[#703BF7]'
              type='submit'
            >
              <img
      ...
      {/* DISCOVER */}
      <div className='flex flex-col px-4 py-[50px]'>
        <img
        ...
        <div className='flex flex-col gap-10'>
          <div className='flex flex-col gap-2'>
            <h3 className='absolute-white font-semibold text-[28px] leading-[1.5]'>
      ...
      <div className='flex flex-col px-4 py-[50px]'>
        ...
        <div className='flex flex-col gap-10'>
          ...
          <form className='flex flex-col rounded-[12px] gap-5 p-4 border border-[#262626]'>
            ...
            <div className='flex flex-col gap-[10px]'>
              ...
              <div className='w-full flex items-center justify-between rounded-[6px] border border-[#262626] bg-[#1a1a1a] px-5 py-4'></div>
            </div>
          </form>
        </div>
      </div>
